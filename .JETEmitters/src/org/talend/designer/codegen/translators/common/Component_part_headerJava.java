...
public class Component_part_headerJava
{
  ...
  protected final String TEXT_79 = NL + "\t\t\trunStat.updateStatAndLog(execStat,enableLogStash,iterateId,1,1";
  protected final String TEXT_80 = NL + "\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\trunStat.updateStatOnConnection(iterateId,1,1";
  protected final String TEXT_81 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\t\tif(enableLogStash) {" + NL + "\t\t\t\t\t\trunStat.log(iterateId,1,1";
  protected final String TEXT_83 = NL + "\t\t\t\t\trunStat.updateStatAndLog(execStat,enableLogStash,iterateId,1,1";
  protected final String TEXT_84 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(iterateId,1,1";
  protected final String TEXT_86 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\t\t\tif(enableLogStash) {" + NL + "\t\t\t\t\t\t\trunStat.log(iterateId,1,1";
  protected final String TEXT_88 = NL + "    \t\t\tif(log.isTraceEnabled()){" + NL + "    \t\t\t\tlog.trace(\"";
  protected final String TEXT_89 = " - \" + (";
  protected final String TEXT_90 = "==null? \"\": ";
  protected final String TEXT_91 = ".toLogString()));" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_92 = NL + "\t\tint tos_count_";
  protected final String TEXT_93 = " = 0;" + NL + "\t\t";
  protected final String TEXT_94 = NL + "\t\t\tif(enableLogStash) {" + NL + "\t\t\t\t";
  protected final String TEXT_95 = ".addCM(\"";
  protected final String TEXT_96 = "\", \"";
  protected final String TEXT_97 = "Process(globalMap);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\tif(";
  protected final String TEXT_99 = "){" + NL + "\t\t\t\t\trunStat.updateStatOnConnectionAndLog(globalMap,iterateLoop,iterateId,";
  protected final String TEXT_100 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_101 = NL + "\t\t\t\t\trunStat.updateStatAndLog(execStat,enableLogStash,iterateId,0,0";
  protected final String TEXT_102 = NL + "\t\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(iterateId,0,0";
  protected final String TEXT_103 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_104 = NL + "\t\t\t\t\t\tif(enableLogStash){" + NL + "\t\t\t\t\t\t\trunStat.log(iterateId,0,0";
  protected final String TEXT_105 = NL + "\t\t\t\tresourceMap.put(\"inIterateVComp\", true);" + NL + "\t\t\t";
  protected final String TEXT_106 = NL + "\t\t\t\tresourceMap.remove(\"inIterateVComp\");" + NL + "\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\t\t\tresourceMap.remove(\"inIterateVComp\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_108 = NL + "\t\t\t\t\t\tresourceMap.put(\"inIterateVComp\", true);" + NL + "\t\t\t\t\t";
...
LogUtil log = null;
    ...
    for(IConnection con : connSet){if(con.getUniqueName().equals((String)codeGenArgument.getIncomingName())){
    stringBuffer.append(TEXT_71);
    stringBuffer.append(con.getUniqueName());
    stringBuffer.append(TEXT_72);
    }}
