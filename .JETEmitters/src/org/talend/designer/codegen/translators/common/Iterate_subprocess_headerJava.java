...
public class Iterate_subprocess_headerJava
{
  ...
  protected final String TEXT_22 = "Thread(java.util.Map<String, Object> globalMap";
  protected final String TEXT_23 = ", int threadID) {" + NL + "\t\t\t\t\tsuper();" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_31 = NL + "\t\t\t\t\t\tsynchronized (globalMap) {" + NL + "\t\t\t\t\t\t\tthis.globalMap = java.util.Collections.synchronizedMap(new ThreadedMap(globalMap));" + NL + "\t\t\t\t\t";
  protected final String TEXT_32 = ".this.obj) {" + NL + "\t\t\t\t\t\t\tthis.globalMap = new ThreadedMap(globalMap);" + NL + "\t\t\t\t\t";
  protected final String TEXT_33 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\titerateId = \".\" + threadID;" + NL + "\t\t\t\t\t";
  protected final String TEXT_34 = NL + "\t\t\t\t\t\titerateLoop++;" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_36 = NL + "\t\t\t\t\t\t\tlocalContext.";
  protected final String TEXT_37 = " = context.";
  protected final String TEXT_38 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_39 = NL + "\t\t\t\t}" + NL + "" + NL + "" + NL + "\t\t\t\tpublic void run() {\t\t" + NL + "\t\t" + NL + "\t\t\t\t\tjava.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "\t\t\t\t\tthreadRunResultMap.put(\"errorCode\", null);" + NL + "\t\t\t\t\tthreadRunResultMap.put(\"status\", \"\");" + NL + "\t\t\t\t\tthreadLocal.set(threadRunResultMap);" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tthis.isRunning = true;" + NL + "\t\t\t\t\tString currentComponent = \"\";" + NL + "\t\t\t\t\tjava.util.Map<String, Object> resourceMap = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\t\t";
  protected final String TEXT_40 = NL + "\t\t\t\t\t\tString currentVirtualComponent = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_41 = NL + "\t\t\t\t\ttry {\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_42 = NL + "\t\t\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_43 = "\",0,\"exec\"+iterateId);" + NL + "\t\t\t\t\t\t\t}\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\t\tif(execStat){\t\t\t\t" + NL + "\t       \t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_45 = "\", 3, 0);" + NL + "\t\t\t\t\t}           \t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t\tif(execStat){" + NL + "\t\t\t\t\trunStat.updateStatOnIterate(\"";
  protected final String TEXT_47 = "\", RunStat.RUNNING);" + NL + "\t\t\t\t}        \t\t" + NL + "\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\t\tif(execStat){" + NL + "\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_49 = "\", 1, \"exec\" + NB_ITERATE_";
  protected final String TEXT_50 = ");" + NL + "\t\t\t\t\t//Thread.sleep(1000);" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\t";
