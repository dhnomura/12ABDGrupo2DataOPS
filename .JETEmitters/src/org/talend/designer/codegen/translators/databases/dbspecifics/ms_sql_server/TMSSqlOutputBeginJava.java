...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_126 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  ...
  protected final String TEXT_132 = NL + NL + "if(dbschema_";
  protected final String TEXT_133 = " == null || dbschema_";
  protected final String TEXT_134 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_135 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_136 = " = dbschema_";
  ...
  protected final String TEXT_152 = ".commit();";
  protected final String TEXT_153 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_154 = NL + "                              stmtCreate_";
  protected final String TEXT_155 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_156 = "));";
  protected final String TEXT_157 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_158 = ";" + NL + "\t                    if (";
  protected final String TEXT_159 = ") {" + NL + "\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_160 = ".getColumnCount(); i++) {" + NL + "\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_161 = ".getColumnMetadata(i);" + NL + "\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_162 = ".execute(((\"";
  protected final String TEXT_163 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_171 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_172 = ";" + NL + "                    if (";
  protected final String TEXT_173 = ") {" + NL + "                        for (int i = 0; i < dynamic_";
  protected final String TEXT_174 = ".getColumnCount(); i++) {" + NL + "                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_175 = ".getColumnMetadata(i);" + NL + "                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_176 = NL + "                    String keyCheckTable_";
  protected final String TEXT_177 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_182 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_183 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_184 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_185 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_186 = ")== null){//}";
  protected final String TEXT_187 = NL + "                                boolean whetherExist_";
  protected final String TEXT_188 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_189 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_193 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_200 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_205 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_206 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_207 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_208 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_209 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_228 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_229 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_230 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_237 = ".toLowerCase()";
  protected final String TEXT_238 = ") || ((dbschema_";
  protected final String TEXT_239 = " ==null || dbschema_";
  protected final String TEXT_240 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_241 = "(schema_";
  protected final String TEXT_242 = NL + "                                String tableForSearch_";
  ...
  protected final String TEXT_250 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_253 = ".getTables(null, conn_";
  protected final String TEXT_254 = ".getSchema(), tableForSearch_";
  protected final String TEXT_255 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_256 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_257 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_258 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_259 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_260 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_261 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_262 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  ...
  protected final String TEXT_272 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_273 = NL + "                                                      stmtCreate_";
  protected final String TEXT_274 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_275 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_276 = ") {" + NL + "\t\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_277 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_278 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_282 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_283 = NL + "                                                      stmtDrop_";
  protected final String TEXT_284 = NL + "                                        stmtDrop_";
  protected final String TEXT_285 = NL + "                                    }";
  protected final String TEXT_286 = NL + "                                            conn_";
  protected final String TEXT_287 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_288 = NL + "                                                  stmtCreate_";
  protected final String TEXT_289 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_290 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_291 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_292 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_293 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  ...
  protected final String TEXT_298 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_299 = NL + "                              stmtClear_";
  ...
  protected final String TEXT_304 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_305 = NL + "                              stmtTruncCount_";
  protected final String TEXT_306 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_307 = " = stmtTruncCount_";
  protected final String TEXT_308 = ".executeQuery(\"";
  protected final String TEXT_309 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_310 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_311 = " = rsTruncCount_";
  protected final String TEXT_312 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_313 = NL + "                              stmtTrunc_";
  protected final String TEXT_314 = NL + "                conn_";
  protected final String TEXT_315 = NL + "                stmtTrunc_";
  protected final String TEXT_316 = NL + "                    if(!conn_";
  protected final String TEXT_317 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_318 = ".commit();" + NL + "                    }";
  protected final String TEXT_319 = NL + "                deletedCount_";
  protected final String TEXT_320 = " += rsTruncCountNumber_";
  protected final String TEXT_321 = ";" + NL + "            }";
  protected final String TEXT_322 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_325 = NL + "                while(rsTruncCount_";
  protected final String TEXT_326 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_327 = " += rsTruncCount_";
  protected final String TEXT_328 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_336 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_337 = "\", pstmt_";
  protected final String TEXT_338 = " = null;" + NL + "        String keyPsmt_";
  protected final String TEXT_339 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_340 = " + \"]\";" + NL + "        pstmt_";
  protected final String TEXT_341 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_342 = ",insert_";
  protected final String TEXT_343 = ",keyPsmt_";
  ...
  protected final String TEXT_348 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_349 = ".prepareStatement(update_";
  protected final String TEXT_350 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_351 = " + \"] WHERE ";
  protected final String TEXT_352 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_353 = ");" + NL + "        String insert_";
  protected final String TEXT_354 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_355 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_356 = "\", pstmtInsert_";
  protected final String TEXT_357 = ");" + NL + "        String update_";
  protected final String TEXT_358 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_359 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_360 = "\", pstmtUpdate_";
  protected final String TEXT_361 = NL + "        String delete_";
  protected final String TEXT_362 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_363 = ".prepareStatement(delete_";
  protected final String TEXT_364 = NL + NL + "    class BufferLine_";
  protected final String TEXT_365 = " {";
  protected final String TEXT_366 = " ";
  protected final String TEXT_367 = NL + NL + "        public BufferLine_";
  protected final String TEXT_368 = NL + "                    ,";
  protected final String TEXT_369 = NL + "        ){";
  protected final String TEXT_370 = NL + "                    this.";
  protected final String TEXT_371 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_372 = "> sInsertColValueList";
  protected final String TEXT_373 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_374 = " sInsertColValue";
  protected final String TEXT_375 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_376 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_377 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_378 = ".append(\"(";
  protected final String TEXT_379 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_380 = "-1) extendInsertValueStmt_";
  protected final String TEXT_381 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_382 = " = \"INSERT INTO \"+";
  protected final String TEXT_383 = "+\" (";
  protected final String TEXT_384 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_385 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_386 = " =  conn_";
  protected final String TEXT_387 = ");" + NL + "    resourceMap.put(\"pstmt_";
  protected final String TEXT_388 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_389 = " = \"";
  protected final String TEXT_390 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_391 = " =  \"";
  protected final String TEXT_392 = "\";" + NL + "    int rowCount";
  ...
  protected final String TEXT_396 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_397 = " = insert_";
  protected final String TEXT_398 = ".split(\"\\\\?\");";
  protected final String TEXT_399 = NL + "\t\t\tupdate_";
  protected final String TEXT_400 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_401 = " = update_";
  protected final String TEXT_402 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_403 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_404 = NL + "\t\t\tdelete_";
  protected final String TEXT_405 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_406 = " = delete_";
  protected final String TEXT_407 = NL + "\t\t\treplace_";
  protected final String TEXT_408 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_409 = " = replace_";
  protected final String TEXT_410 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_411 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_412 = " = insertIgnore_";
  protected final String TEXT_413 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_414 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_415 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_416 = "\") == true;";
  protected final String TEXT_417 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_418 = ".createStatement();";
  protected final String TEXT_419 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_420 = " ) {" + NL + "\t            stmt_";
  protected final String TEXT_421 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_422 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_423 = NL + "            stmt_";
  protected final String TEXT_424 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_425 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_426 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_427 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_428 = " =null;" + NL + "\t";
  protected final String TEXT_429 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_430 = " = null;" + NL + "\t\t";
  protected final String TEXT_431 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_432 = " =  null;";
  protected final String TEXT_433 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_434 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_435 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_436 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_437 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
