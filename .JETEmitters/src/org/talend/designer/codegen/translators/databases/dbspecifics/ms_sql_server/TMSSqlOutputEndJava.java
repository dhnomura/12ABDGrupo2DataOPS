...
public class TMSSqlOutputEndJava {
  ...
  protected final String TEXT_109 = "(count";
  ...
  protected final String TEXT_128 = NL + NL + "\t\tfor(BufferLine_";
  protected final String TEXT_129 = " bufferL";
  protected final String TEXT_130 = " : sInsertColValueList";
  protected final String TEXT_131 = "){" + NL + "\t\t";
  protected final String TEXT_132 = NL + "\t\t    \tcount";
  protected final String TEXT_133 = " = row2Count";
  protected final String TEXT_134 = "*";
  protected final String TEXT_135 = "+1;" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t\t            count";
  protected final String TEXT_137 = "++;" + NL + "\t\t            ";
  protected final String TEXT_138 = NL + "\t\t\t\tint count_dyn_";
  protected final String TEXT_139 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_140 = ", pstmt_";
  protected final String TEXT_141 = ", count";
  protected final String TEXT_142 = "-1, \"";
  protected final String TEXT_143 = "\");" + NL + "\t\t\t\tcount";
