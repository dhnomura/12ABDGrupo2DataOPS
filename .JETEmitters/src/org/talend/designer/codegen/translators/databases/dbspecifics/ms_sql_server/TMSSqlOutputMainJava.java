...
public class TMSSqlOutputMainJava {
  ...
  protected final String TEXT_92 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_100 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_101 = NL + "                              stmtCreate_";
  protected final String TEXT_102 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_103 = "));";
  protected final String TEXT_104 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_105 = ";" + NL + "\t                    if (";
  protected final String TEXT_106 = ") {" + NL + "\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_107 = ".getColumnCount(); i++) {" + NL + "\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_108 = ".getColumnMetadata(i);" + NL + "\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_109 = ".execute(((\"";
  protected final String TEXT_110 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  protected final String TEXT_111 = ", \"";
  protected final String TEXT_112 = "\")";
  protected final String TEXT_113 = ".toUpperCase()";
  ...
  protected final String TEXT_120 = ") {" + NL + "                        for (int i = 0; i < dynamic_";
  protected final String TEXT_121 = ".getColumnCount(); i++) {" + NL + "                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_122 = ".getColumnMetadata(i);" + NL + "                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_123 = NL;
  protected final String TEXT_124 = NL + "                    String keyCheckTable_";
  protected final String TEXT_125 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_126 = "+\"][\"+";
  protected final String TEXT_127 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_128 = " + \"]\";";
  protected final String TEXT_129 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  ...
  protected final String TEXT_135 = NL + "                                boolean whetherExist_";
  protected final String TEXT_136 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_137 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_138 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_139 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_140 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_141 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_148 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_149 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_153 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_154 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_155 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_156 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_157 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_169 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_170 = "((";
  protected final String TEXT_171 = ")";
  protected final String TEXT_172 = ") || (dbschema_";
  protected final String TEXT_173 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_174 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_175 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_176 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_177 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_178 = " == null || dbschema_";
  protected final String TEXT_179 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_185 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_186 = ".toLowerCase()";
  protected final String TEXT_187 = ") || ((dbschema_";
  protected final String TEXT_188 = " ==null || dbschema_";
  protected final String TEXT_189 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_190 = "(schema_";
  protected final String TEXT_191 = NL + "                                String tableForSearch_";
  protected final String TEXT_192 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_193 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_194 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_195 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_196 = " =  tableForSearch_";
  protected final String TEXT_197 = ".substring(1,tableForSearch_";
  protected final String TEXT_198 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_199 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_200 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_201 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_202 = ".getTables(null, conn_";
  protected final String TEXT_203 = ".getSchema(), tableForSearch_";
  protected final String TEXT_204 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_205 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_206 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_207 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_208 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_209 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_210 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_211 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_212 = ".getTables(";
  protected final String TEXT_213 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_214 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_215 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_216 = ".equalsIgnoreCase(";
  protected final String TEXT_217 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_218 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_219 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  ...
  protected final String TEXT_223 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_224 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_225 = ") {" + NL + "\t\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_226 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_227 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_231 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_232 = NL + "                                                      stmtDrop_";
  protected final String TEXT_233 = NL + "                                        stmtDrop_";
  protected final String TEXT_234 = NL + "                                    }";
  protected final String TEXT_235 = NL + "                                            conn_";
  protected final String TEXT_236 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_237 = NL + "                                                  stmtCreate_";
  protected final String TEXT_238 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_239 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_240 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_241 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_242 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_243 = NL + "                                    stmtCreate_";
  protected final String TEXT_244 = NL + "                                }";
  protected final String TEXT_245 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_246 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_247 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_248 = NL + "                              stmtClear_";
  protected final String TEXT_249 = NL + "                stmtClear_";
  protected final String TEXT_250 = ".executeUpdate(\"";
  protected final String TEXT_251 = "\");";
  protected final String TEXT_252 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_253 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_254 = NL + "                              stmtTruncCount_";
  protected final String TEXT_255 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_256 = " = stmtTruncCount_";
  protected final String TEXT_257 = ".executeQuery(\"";
  protected final String TEXT_258 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_259 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_260 = " = rsTruncCount_";
  protected final String TEXT_261 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_262 = NL + "                              stmtTrunc_";
  protected final String TEXT_263 = NL + "                conn_";
  protected final String TEXT_264 = NL + "                stmtTrunc_";
  protected final String TEXT_265 = NL + "                    if(!conn_";
  protected final String TEXT_266 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_267 = ".commit();" + NL + "                    }";
  protected final String TEXT_268 = NL + "                deletedCount_";
  protected final String TEXT_269 = " += rsTruncCountNumber_";
  protected final String TEXT_270 = ";" + NL + "            }";
  protected final String TEXT_271 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_272 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_277 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_278 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_279 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_280 = " + \"] (";
  protected final String TEXT_281 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_282 = "\")+\") VALUES (";
  protected final String TEXT_283 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_284 = ")+\")\";";
  protected final String TEXT_285 = " + \"] (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_286 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_287 = NL + "        //String insert_";
  protected final String TEXT_288 = ") VALUES (";
  protected final String TEXT_289 = ")\";";
  protected final String TEXT_290 = NL + "        pstmt_";
  ...
  protected final String TEXT_295 = " = null;" + NL + "        // [%connection%][psmt][tableName]" + NL + "        String keyPsmt_";
  protected final String TEXT_296 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_297 = " + \"]\";" + NL + "\t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_298 = ")== null){" + NL + "\t\t\tpstmt_";
  protected final String TEXT_299 = ");" + NL + "\t\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_300 = ");" + NL + "\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_301 = ", pstmt_";
  protected final String TEXT_302 = ");" + NL + "\t\t}else{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_303 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_304 = ");" + NL + "\t\t}";
  protected final String TEXT_305 = NL + "\t\t\t\tString update_";
  protected final String TEXT_306 = " = \"UPDATE [\" + tableName_";
  protected final String TEXT_307 = " + \"] SET ";
  protected final String TEXT_308 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_309 = "\")+\" WHERE ";
  protected final String TEXT_310 = "\";";
  protected final String TEXT_311 = " + \"] SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_312 = ".prepareStatement(update_";
  protected final String TEXT_313 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_314 = " + \"] WHERE ";
  protected final String TEXT_315 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_316 = ");" + NL + "        pstmtInsert_";
  protected final String TEXT_317 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_318 = "\", pstmtInsert_";
  protected final String TEXT_319 = ");" + NL + "        pstmtUpdate_";
  protected final String TEXT_320 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_321 = "\", pstmtUpdate_";
  protected final String TEXT_322 = NL + "        pstmtUpdate_";
  protected final String TEXT_323 = NL + "        String delete_";
  protected final String TEXT_324 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_325 = ".prepareStatement(delete_";
  protected final String TEXT_326 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_327 = NL + "       \t";
  protected final String TEXT_328 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_329 = " = insert_";
  protected final String TEXT_330 = ".split(\"\\\\?\");";
  protected final String TEXT_331 = NL + "\t\t\tupdate_";
  protected final String TEXT_332 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_333 = " = update_";
  protected final String TEXT_334 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_335 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_336 = NL + "\t\t\tdelete_";
  protected final String TEXT_337 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_338 = " = delete_";
  protected final String TEXT_339 = NL + "\t\t\treplace_";
  protected final String TEXT_340 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_341 = " = replace_";
  protected final String TEXT_342 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_343 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_344 = " = insertIgnore_";
  protected final String TEXT_345 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_346 = " ) {" + NL + "\t            stmt_";
  protected final String TEXT_347 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_348 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_349 = NL + "            stmt_";
  protected final String TEXT_350 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_351 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_352 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_353 = " = buffersSize_";
  protected final String TEXT_354 = ";";
  protected final String TEXT_355 = NL + "\t\t\tbatchSize_";
  protected final String TEXT_356 = NL + NL;
  protected final String TEXT_357 = NL + "\t        if(isShareIdentity_";
  protected final String TEXT_358 = ") {" + NL + "\t            stmt_";
  protected final String TEXT_359 = NL + "        whetherReject_";
  protected final String TEXT_360 = " = false;";
  protected final String TEXT_361 = NL + "            try {";
  protected final String TEXT_362 = NL + "                        query_";
  protected final String TEXT_363 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_364 = ",insertSQLSplits_";
  protected final String TEXT_365 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_378 = NL + "                insertedCount_";
  protected final String TEXT_379 = " = insertedCount_";
  protected final String TEXT_380 = " + pstmt_";
  protected final String TEXT_381 = ".executeUpdate();";
  protected final String TEXT_382 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_383 = " = true;";
  protected final String TEXT_384 = NL + "                    throw(e);";
  protected final String TEXT_385 = " = new ";
  protected final String TEXT_386 = "Struct();";
  protected final String TEXT_387 = NL + "                        rejectedCount_";
  protected final String TEXT_388 = " = rejectedCount_";
  protected final String TEXT_389 = " + 1;";
  protected final String TEXT_390 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_391 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_392 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_393 = NL + "            }";
  protected final String TEXT_394 = NL + "\t\t     \tint counter";
  protected final String TEXT_395 = " = rowCount";
  protected final String TEXT_396 = " * ";
  protected final String TEXT_397 = " + 1;" + NL + "" + NL + "\t\t     \t \t";
  protected final String TEXT_398 = NL + "\t\t                        counter";
  protected final String TEXT_399 = "++;" + NL + "\t\t                        ";
  protected final String TEXT_400 = NL + "\t\t\t\t\t\t\t\tint count_dyn_";
  protected final String TEXT_401 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_402 = ", counter";
  protected final String TEXT_403 = "-1, \"";
  protected final String TEXT_404 = "\");" + NL + "\t\t\t\t\t\t\t\tcounter";
  protected final String TEXT_405 = "+=count_dyn_";
  protected final String TEXT_406 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_407 = NL + NL + "\t\t                sInsertColValue";
  protected final String TEXT_408 = " = new BufferLine_";
  protected final String TEXT_409 = "(" + NL + "\t\t                ";
  protected final String TEXT_410 = NL + "\t\t                            ," + NL + "\t\t                            ";
  protected final String TEXT_411 = NL + "\t\t                        ";
  protected final String TEXT_412 = NL + "\t\t\t\t\t\t, ";
  protected final String TEXT_413 = NL + "\t\t\t\t\t";
  protected final String TEXT_414 = NL + "\t\t                );" + NL + "" + NL + "\t\t                sInsertColValueList";
  protected final String TEXT_415 = ".add(sInsertColValue";
  protected final String TEXT_416 = ");" + NL + "" + NL + "\t\t                rowCount";
  protected final String TEXT_417 = "++;" + NL + "\t\t";
  protected final String TEXT_418 = NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_419 = NL + "\t\t                if(rowCount";
  protected final String TEXT_420 = " == ";
  protected final String TEXT_421 = "){" + NL + "\t\t                    insertedCount_";
  protected final String TEXT_422 = ".executeUpdate();" + NL + "\t\t                    sInsertColValueList";
  protected final String TEXT_423 = ".clear();" + NL + "\t\t                    rowCount";
  protected final String TEXT_424 = " = 0;" + NL + "\t\t                    counter";
  protected final String TEXT_425 = "=1;" + NL + "\t\t                }" + NL + NL + NL + NL;
  protected final String TEXT_426 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_427 = ",updateSQLSplits_";
  protected final String TEXT_428 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_429 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_430 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\t\t\tquery_";
  protected final String TEXT_432 = NL + "\t\t\t\t\t\t\tquery_";
  protected final String TEXT_433 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_434 = NL + "    \t\tpstmt_";
  protected final String TEXT_435 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_436 = NL + "    \t\t";
  protected final String TEXT_437 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_438 = NL + "                updatedCount_";
  protected final String TEXT_439 = " = updatedCount_";
  protected final String TEXT_440 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_441 = NL + "            int checkCount_";
  protected final String TEXT_442 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_443 = " = pstmt_";
  protected final String TEXT_444 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_445 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_446 = " = rs_";
  protected final String TEXT_447 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_448 = " > 0) {";
  protected final String TEXT_449 = NL + "                            query_";
  protected final String TEXT_450 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_451 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_452 = NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_461 = NL + "                    globalMap.put(\"";
  protected final String TEXT_462 = NL + "                    updatedCount_";
  protected final String TEXT_463 = " + pstmtUpdate_";
  protected final String TEXT_464 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_465 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_466 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_467 = NL + "                        throw(e);";
  protected final String TEXT_468 = NL + "                    \tnb_line_";
  protected final String TEXT_469 = "++;" + NL + "                    \t";
  protected final String TEXT_470 = NL + "                                ";
  protected final String TEXT_471 = NL + "                            rejectedCount_";
  protected final String TEXT_472 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_473 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_474 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_475 = ", pstmtInsert_";
  protected final String TEXT_476 = NL + "                    insertedCount_";
  protected final String TEXT_477 = " + pstmtInsert_";
  protected final String TEXT_478 = NL + "                }" + NL + "            }";
  protected final String TEXT_479 = NL + "            int updateFlag_";
  protected final String TEXT_480 = "=0;";
  protected final String TEXT_481 = NL + "\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_482 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_483 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_484 = NL + "\t\t\t\t\t\t\t\t\tquery_";
  protected final String TEXT_485 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_486 = NL + "                updateFlag_";
  protected final String TEXT_487 = "=pstmtUpdate_";
  protected final String TEXT_488 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_489 = "+updateFlag_";
  protected final String TEXT_490 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_491 = " == 0) {" + NL + "            \t";
  protected final String TEXT_492 = NL + "\t\t\t\tquery_";
  protected final String TEXT_493 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_494 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_495 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_496 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_497 = NL + "    \t\t\t\t";
  protected final String TEXT_498 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_505 = " = deletedCount_";
  protected final String TEXT_506 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_507 = NL + "                \tnb_line_";
  protected final String TEXT_508 = "++;" + NL + "                \t";
  protected final String TEXT_509 = NL + NL + "        java.sql.ResultSet rs_";
  ...
  protected final String TEXT_513 = ".getInt(1);" + NL + "        }" + NL + "" + NL + "        if (checkCount_";
  protected final String TEXT_514 = " < 1) {";
  protected final String TEXT_515 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\twhetherReject_";
  protected final String TEXT_516 = NL + "                throw(e);";
  protected final String TEXT_517 = NL + "            \tnb_line_";
  protected final String TEXT_518 = "++;" + NL + "            \t";
  protected final String TEXT_519 = NL + "\t            ";
  protected final String TEXT_520 = NL + "                \trejectedCount_";
  protected final String TEXT_521 = " + 1;" + NL + "                \t";
  protected final String TEXT_522 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_523 = NL + "            if(!whetherReject_";
  protected final String TEXT_524 = NL + "            \t//////////batch execute by batch size///////" + NL + "            \tclass LimitBytesHelper_";
  protected final String TEXT_525 = "{" + NL + "            \t\tpublic int limitBytePart1(int counter,java.sql.PreparedStatement pstmt_";
  protected final String TEXT_526 = ") throws Exception {" + NL + "                try {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_527 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_528 = ": pstmt_";
  protected final String TEXT_529 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_530 = " == -2 || countEach_";
  protected final String TEXT_531 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcounter += countEach_";
  protected final String TEXT_532 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_533 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_534 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_535 = NL + "                \tint countSum_";
  protected final String TEXT_536 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_537 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcounter += (countEach_";
  protected final String TEXT_538 = " < 0 ? 0 : countEach_";
  protected final String TEXT_539 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t" + NL + "            \t    \t";
  protected final String TEXT_540 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_541 = NL + "               \t\t\t }" + NL + "    \t\t\t\treturn counter;" + NL + "            \t}" + NL + "            \t" + NL + "            \tpublic int limitBytePart2(int counter,java.sql.PreparedStatement pstmt_";
  protected final String TEXT_542 = ") throws Exception {" + NL + "                try {" + NL + "                \t\t";
  protected final String TEXT_543 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_544 = NL + "                \t" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_545 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "            \t    \t";
  protected final String TEXT_546 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_547 = NL + "                \t\t}\t" + NL + "                \treturn counter;\t" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_548 = NL + "    \t\tif ((batchSize_";
  protected final String TEXT_549 = " > 0) && (batchSize_";
  protected final String TEXT_550 = " <= batchSizeCounter_";
  protected final String TEXT_551 = ")) {" + NL + "    \t\t" + NL + "    \t\t            ";
  protected final String TEXT_552 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_553 = " = new LimitBytesHelper_";
  protected final String TEXT_554 = "().limitBytePart1(insertedCount_";
  protected final String TEXT_555 = ",pstmt_";
  protected final String TEXT_556 = ");" + NL + "            \t    \t";
  protected final String TEXT_557 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_558 = "().limitBytePart1(updatedCount_";
  protected final String TEXT_559 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_560 = "().limitBytePart1(deletedCount_";
  protected final String TEXT_561 = NL + "    \t\t\t" + NL + "\t\t\t    batchSizeCounter_";
  protected final String TEXT_562 = " = 0;" + NL + "\t\t\t}" + NL + "    \t\t";
  protected final String TEXT_563 = NL + NL + "    \t////////////commit every////////////" + NL + "    \t\t\t";
  protected final String TEXT_564 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_565 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_566 = " <= commitCounter_";
  protected final String TEXT_567 = NL + "                if ((batchSize_";
  protected final String TEXT_568 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_569 = " > 0)) {" + NL + "    \t\t            ";
  protected final String TEXT_570 = NL + "            \tbatchSizeCounter_";
  protected final String TEXT_571 = " = 0;" + NL + "            \t}";
  protected final String TEXT_572 = NL + "                \t";
  protected final String TEXT_573 = NL + "                \tconn_";
  protected final String TEXT_574 = ".commit();" + NL + "            \t\t";
  protected final String TEXT_575 = NL + "                \tcommitCounter_";
  protected final String TEXT_576 = "=0;" + NL + "                }";
  protected final String TEXT_577 = NL + "\t\tif (isShareIdentity_";
  protected final String TEXT_578 = " ) {" + NL + "        \t stmt_";
  protected final String TEXT_579 = " +\"] OFF\");" + NL + "        }";
