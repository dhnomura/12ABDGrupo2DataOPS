...
public class TExternalSortOutputMainJava
{
  ...
  protected final String TEXT_14 = "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tout_";
  protected final String TEXT_15 = ".write(OUT_DELIM_";
  protected final String TEXT_16 = ");";
  protected final String TEXT_17 = NL + "    \t\t\tout_";
  protected final String TEXT_18 = ".write(OUT_DELIM_ROWSEP_";
  protected final String TEXT_19 = ");" + NL + "    \t\t\tnb_line_";
