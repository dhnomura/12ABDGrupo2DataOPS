...
public class TFileOutputDelimitedBeginJava
{
  ...
  protected final String TEXT_202 = NL + "                            synchronized (fileName_";
  protected final String TEXT_203 = ".intern()) {";
  ...
  protected final String TEXT_317 = NL + "                        synchronized (fileName_";
