...
public class TMapBeginJava {
  ...
  protected final String TEXT_143 = NL + NL + "        }" + NL + "        " + NL + "      } " + NL + "    }" + NL + "" + NL + "    public void writeData(ObjectOutputStream dos) {" + NL + "        try {" + NL + "" + NL + "           \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "" + NL + "\t\t";
  protected final String TEXT_144 = NL + "\t\t            \tdos.write";
  protected final String TEXT_145 = "(this.";
  protected final String TEXT_146 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\t\t\tif(this.";
  protected final String TEXT_148 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_149 = ".getBytes(utf8Charset);" + NL + "           \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "               \t\t\t\tdos.write(byteArray);" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_150 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_151 = ".getTime());" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_152 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "           \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_153 = ".length);" + NL + "               \t\t\t\tdos.write(this.";
  protected final String TEXT_154 = ");" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_155 = NL + "       \t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_156 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \t";
  protected final String TEXT_157 = NL + "           \t\t\t\t\t\t\tdos.writeObject(this.";
  protected final String TEXT_158 = ");" + NL + "           \t\t\t\t\t";
  protected final String TEXT_159 = NL + "           \t\t\t\t\t\t\tdos.write";
  protected final String TEXT_160 = NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_161 = "(this.exprKey_";
  protected final String TEXT_162 = NL + "\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_163 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_164 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_165 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "           \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_166 = ".length);" + NL + "               \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_167 = NL + "       \t\t\t    \tdos.writeObject(this.exprKey_";
  protected final String TEXT_168 = NL + "           \t\t\t\t\t\t\tdos.writeObject(this.exprKey_";
  protected final String TEXT_169 = NL + "        }" + NL + "    }" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t} // G_TM_B_001" + NL + "\t" + NL + "\t";
  protected final String TEXT_170 = NL + "\t" + NL + "" + NL + "\torg.talend.designer.components.lookup.persistent.PersistentRowSorterIterator<SortableRow_";
  protected final String TEXT_171 = "> fsi_";
  protected final String TEXT_172 = " = " + NL + "\t\tnew org.talend.designer.components.lookup.persistent.PersistentRowSorterIterator<SortableRow_";
  protected final String TEXT_173 = ">(" + NL + "\t\t\t";
  protected final String TEXT_174 = " + \"/\"+ jobName +\"_tMapData_\" + Thread.currentThread().getId() + \"_\" + pid +\"_";
  protected final String TEXT_175 = "\", ";
  protected final String TEXT_176 = ") {" + NL + "\t\t\tpublic SortableRow_";
  protected final String TEXT_177 = " createRowInstance() {" + NL + "\t\t\t\treturn new SortableRow_";
  protected final String TEXT_178 = "();" + NL + "\t\t\t}" + NL + "\t\t};" + NL + "\t" + NL + "\tfsi_";
  protected final String TEXT_179 = ".initPut();" + NL + "" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_180 = "        " + NL + "        " + NL + "" + NL + "" + NL + "" + NL + "        " + NL + NL + NL + NL + NL + NL + NL + NL;
