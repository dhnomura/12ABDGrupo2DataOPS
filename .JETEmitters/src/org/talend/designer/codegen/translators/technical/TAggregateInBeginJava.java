...
public class TAggregateInBeginJava
{
  ...
  protected final String TEXT_34 = NL + "java.util.Collection<AggOperationStruct_";
  protected final String TEXT_35 = "> values_";
  protected final String TEXT_36 = " = hash_";
  protected final String TEXT_37 = ".values();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_38 = "_NB_LINE\", values_";
  protected final String TEXT_39 = ".size());" + NL;
  protected final String TEXT_40 = NL + "for(AggOperationStruct_";
  protected final String TEXT_41 = " aggregated_row_";
  protected final String TEXT_42 = " : values_";
  protected final String TEXT_43 = ") { // G_AggR_600" + NL + NL;
