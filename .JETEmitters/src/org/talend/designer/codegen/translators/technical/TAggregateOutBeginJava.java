...
public class TAggregateOutBeginJava
{
  ...
  protected final String TEXT_2 = NL + "// ------------ Seems it is not used" + NL + "" + NL + "java.util.Map hashAggreg_";
  ...
  protected final String TEXT_26 = " other = (AggCountDistinctValuesStruct_";
  protected final String TEXT_27 = ") obj;" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_31 = NL + "\t\t\t\t\t\t\t\t\tif(!java.util.Arrays.equals(this.";
  protected final String TEXT_32 = ", other.";
  protected final String TEXT_33 = ")) {" + NL + "\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_43 = "int count = 0;" + NL + "       \t\t\t";
  protected final String TEXT_44 = "java.util.Set<AggCountDistinctValuesStruct_";
  protected final String TEXT_45 = "> distinctValues_";
  protected final String TEXT_46 = " = new java.util.HashSet<AggCountDistinctValuesStruct_";
  protected final String TEXT_47 = ">();" + NL + "           \t\t\t";
  protected final String TEXT_48 = "BigDecimal ";
  protected final String TEXT_49 = ";" + NL + "           \t\t\t";
  protected final String TEXT_50 = NL + "           \t\t\t";
  protected final String TEXT_51 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_52 = "int ";
  protected final String TEXT_53 = "_clmCount = 0;" + NL + "           \t\t\t";
  protected final String TEXT_54 = "_count = 0;" + NL + "           \t\t\t";
  protected final String TEXT_55 = "StringBuilder ";
  protected final String TEXT_56 = " = new StringBuilder();" + NL + "           \t\t\tboolean ";
  protected final String TEXT_57 = "_firstEmpty = false;" + NL + "           \t\t\t";
  protected final String TEXT_58 = "java.util.List ";
  protected final String TEXT_59 = " = new java.util.ArrayList();" + NL + "           \t\t\t";
  protected final String TEXT_60 = "org.talend.sdi.geometry.Geometry ";
  protected final String TEXT_61 = " = null;" + NL + "           \t\t\t";
  protected final String TEXT_62 = "java.util.List<Double> ";
  protected final String TEXT_63 = " = new java.util.ArrayList<Double>();" + NL + "           \t\t\t";
  protected final String TEXT_64 = NL + "         \t\t\t";
  protected final String TEXT_65 = " = (";
  protected final String TEXT_66 = ") ";
  protected final String TEXT_67 = NL + "        " + NL + "\t    @Override" + NL + "\t\tpublic int hashCode() {" + NL + "\t\t\tif (this.hashCodeDirty) {" + NL + "\t\t\t\tfinal int prime = PRIME;" + NL + "\t\t\t\tint result = DEFAULT_HASHCODE;" + NL + "\t\t";
  protected final String TEXT_68 = NL + "\t\t\t        \t\t\tresult = prime * result + (this.";
  protected final String TEXT_69 = " ? 1231 : 1237);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\t\t\t\t\tresult = prime * result + (int) this.";
  protected final String TEXT_71 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\t\t\t\tresult = prime * result + java.util.Arrays.hashCode(this.";
  protected final String TEXT_73 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\t\t\t\t\tresult = prime * result + ((this.";
  protected final String TEXT_75 = ".hashCode());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_76 = NL + "\t    \t\tthis.hashCode = result;" + NL + "\t    \t\tthis.hashCodeDirty = false;\t\t" + NL + "\t\t\t}" + NL + "\t\t\treturn this.hashCode;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t@Override" + NL + "\t\tpublic boolean equals(Object obj) {" + NL + "\t\t\tif (this == obj) return true;" + NL + "\t\t\tif (obj == null) return false;" + NL + "\t\t\tif (getClass() != obj.getClass()) return false;" + NL + "\t\t\tfinal AggOperationStruct_";
  protected final String TEXT_77 = " other = (AggOperationStruct_";
  protected final String TEXT_78 = ") obj;" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\t\t\t\tif (this.";
  protected final String TEXT_80 = ") " + NL + "\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\t\t\t\tif(!java.util.Arrays.equals(this.";
  protected final String TEXT_82 = ")) {" + NL + "\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_83 = " == null) {" + NL + "\t\t\t\t\t\t\t\tif (other.";
  protected final String TEXT_84 = " != null) " + NL + "\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t} else if (!this.";
  protected final String TEXT_85 = ")) " + NL + "\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t" + NL + "\t\t\treturn true;" + NL + "\t\t}" + NL + "  " + NL + "        " + NL + "\t} // G_OutBegin_AggR_100" + NL;
  protected final String TEXT_87 = NL + "\tlog.warn(\" ";
  protected final String TEXT_88 = " \" + ";
  protected final String TEXT_89 = NL + "\t\t";
  protected final String TEXT_90 = "\"";
  protected final String TEXT_91 = ");";
  protected final String TEXT_92 = NL + "\tSystem.err.println(" + NL + "\t";
  protected final String TEXT_93 = NL + "\t);" + NL + "\t";
  protected final String TEXT_94 = NL + "\tAggOperationStruct_";
  protected final String TEXT_95 = " operation_result_";
  protected final String TEXT_96 = " = null;" + NL + "\tAggOperationStruct_";
  protected final String TEXT_97 = " operation_finder_";
  protected final String TEXT_98 = " = new AggOperationStruct_";
  protected final String TEXT_99 = "();" + NL + "\tjava.util.Map<AggOperationStruct_";
  protected final String TEXT_100 = ",AggOperationStruct_";
  protected final String TEXT_101 = "> hash_";
  protected final String TEXT_102 = " = new java.util.HashMap<AggOperationStruct_";
  protected final String TEXT_103 = ">();" + NL + "\t";
  protected final String TEXT_104 = NL + "\tString delimiter_";
