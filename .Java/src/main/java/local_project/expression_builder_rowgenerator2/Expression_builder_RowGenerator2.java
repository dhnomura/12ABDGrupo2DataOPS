...
package local_project.expression_builder_rowgenerator2;
...
public class Expression_builder_RowGenerator2 implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Expression_builder_RowGenerator2 = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2.length == 0) {
						commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2 = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Expression_builder_RowGenerator2) {
...
///////////////////////    			
				...
				class tRowGenerator_1Randomizer {
					public String getRandomnewColumn() {
						...
						return "" + (null == null ? "Mr." : null + null.replace("Sr.", "Mr.")) + "";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Expression_builder_RowGenerator2.class.getClassLoader().getResourceAsStream(
					"local_project/expression_builder_rowgenerator2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 30600 characters generated by Talend Open Studio for Data Integration on the
 * July 11, 2021 6:31:21 PM BRT
 ************************************************************************************************/