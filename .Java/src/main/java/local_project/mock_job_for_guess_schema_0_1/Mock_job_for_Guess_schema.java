...
package local_project.mock_job_for_guess_schema_0_1;
...
public class Mock_job_for_Guess_schema implements TalendJob {
	...
	public void tLibraryLoad_4_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tLibraryLoad_5_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tLibraryLoad_4_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tLibraryLoad_5_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tLibraryLoad_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				/**
				 * [tLibraryLoad_5 process_data_begin ] start
				 */

				currentComponent = "tLibraryLoad_5";

				/**
				 * [tLibraryLoad_5 process_data_begin ] stop
				 */

				/**
				 * [tLibraryLoad_5 process_data_end ] start
				 */

				currentComponent = "tLibraryLoad_5";

				/**
				 * [tLibraryLoad_5 process_data_end ] stop
				 */
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String user = "sqlfamily";
				if (user != null && !"".equals(user)) {
					prop.put("user", user);
				}
				String password = "sqlf@m1ly";
				...
				String url = "jdbc:jtds:sqlserver://sqlservercentralpublic.database.windows.net:1433/AdventureWorks;";
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery(
						"SELECT SalesLT.Address.AddressID, 		SalesLT.Address.AddressLine1, 		SalesLT.Address.AddressLine2, 		SalesLT.Address.City, 		SalesLT.Address.PostalCode, 		SalesLT.Address.rowguid, 		SalesLT.Address.ModifiedDate FROM	SalesLT.Address");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"D:/programas/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/temp/TempGuessSchemaDelimitedFile.csv"))
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"local_project/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
		...
		} catch (TalendException e_tLibraryLoad_4) {
			globalMap.put("tLibraryLoad_4_SUBPROCESS_STATE", -1);

			e_tLibraryLoad_4.printStackTrace();
		...
		} catch (TalendException e_tLibraryLoad_5) {
			globalMap.put("tLibraryLoad_5_SUBPROCESS_STATE", -1);

			e_tLibraryLoad_5.printStackTrace();
...
/************************************************************************************************
 * 45048 characters generated by Talend Open Studio for Data Integration on the
 * July 10, 2021 5:55:25 PM BRT
 ************************************************************************************************/