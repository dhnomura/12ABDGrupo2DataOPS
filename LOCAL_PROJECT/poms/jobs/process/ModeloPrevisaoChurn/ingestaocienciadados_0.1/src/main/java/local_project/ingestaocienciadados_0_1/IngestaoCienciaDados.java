	...
	public static class row24Struct implements routines.system.IPersistableComparableLookupRow<row24Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.ModelName = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.ModelName, dos, oos);
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				JoinProductStruct row24 = JoinProduct;
				...
				// source node:tFileOutputDelimited_4 - inputs:(JoinProduct)
				// outputs:(row24,row24) | target node:tAdvancedHash_row24 - inputs:(row24)
				// outputs:()
				// linked node: tMap_6 - inputs:(row24,row21,row23,row22)
				// outputs:(DatasetCienciaDeDados)
				...
				fileName_tFileOutputDelimited_4 = (new java.io.File(
						"D:/Projetos/12ABDGrupo2DataOPS/DL/Harmonized/ChrunProductCurated"
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:8CGlxrP2Y1y3/p+26qWsMHgIyAooSE7Lf89tZ9lhGpUT+DOHLA==");
...
// Start of branch "JoinProduct"
						if (JoinProduct != null) {
							...
							row24_HashRow.ProductID = row24.ProductID;

							row24_HashRow.Name = row24.Name;

							row24_HashRow.ProductNumber = row24.ProductNumber;

							row24_HashRow.Color = row24.Color;

							row24_HashRow.StandardCost = row24.StandardCost;

							row24_HashRow.ListPrice = row24.ListPrice;

							row24_HashRow.SellStartDate = row24.SellStartDate;

							row24_HashRow.SellEndDate = row24.SellEndDate;

							row24_HashRow.DiscontinuedDate = row24.DiscontinuedDate;

							row24_HashRow.CategoryName = row24.CategoryName;

							row24_HashRow.ModelName = row24.ModelName;
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:kVsGM9nFag9LyTOfV5tzpc7YQby1RzvnxTf3F5fWqKkHpJ70lQ==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:qo5FuY3w11ZNTA7yOeMbYCBt2DE9dNGnY4t5rRfNHSDL6f7bdw==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:xNmKgn4ra/L8qYrwmx2hvLjPITT0oyjWjEOpLvxWkjmN3n9MyQ==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:zbigpcDLvUL/iPHcYiRFZCTCQUULfKoZAaPKNkNNhzr/9a4VNg==");
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 9) {
							row12.PurchaseOrderNumber = null;
						} else {
							...
							if (tmpContent_tDBInput_5 != null) {
								if (talendToDBList_tDBInput_5.contains(
									...
									row12.PurchaseOrderNumber = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
								} else {
									row12.PurchaseOrderNumber = tmpContent_tDBInput_5;
								}
							} else {
								row12.PurchaseOrderNumber = null;
							}
						...
						if (colQtyInRs_tDBInput_5 < 10) {
							...
							if (tmpContent_tDBInput_5 != null) {
								if (talendToDBList_tDBInput_5.contains(
									...
									row12.AccountNumber = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
								} else {
									row12.AccountNumber = tmpContent_tDBInput_5;
								}
							} else {
								row12.AccountNumber = null;
							}
						...
						if (colQtyInRs_tDBInput_5 < 11) {
							...
							row12.CustomerID = rs_tDBInput_5.getInt(11);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 12) {
							...
							row12.ShipToAddressID = rs_tDBInput_5.getInt(12);
							if (rs_tDBInput_5.wasNull()) {
								row12.ShipToAddressID = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 13) {
							...
							row12.BillToAddressID = rs_tDBInput_5.getInt(13);
							if (rs_tDBInput_5.wasNull()) {
								row12.BillToAddressID = null;
							}
						}
						...
						if (colQtyInRs_tDBInput_5 < 16) {
							...
							row12.SubTotal = rs_tDBInput_5.getObject(16);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 17) {
							...
							row12.TaxAmt = rs_tDBInput_5.getObject(17);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 18) {
							...
							row12.Freight = rs_tDBInput_5.getObject(18);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 19) {
							...
							row12.TotalDue = rs_tDBInput_5.getBigDecimal(19);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (colQtyInRs_tDBInput_5 < 21) {
							...
							row12.rowguid = rs_tDBInput_5.getObject(21);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 22) {
							...
							row12.ModifiedDate = mssqlGTU_tDBInput_5.getDate(rsmd_tDBInput_5, rs_tDBInput_5, 22);
						...
						sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
						if (row12.PurchaseOrderNumber != null) {
							sb_tFileOutputDelimited_9.append(row12.PurchaseOrderNumber);
						}
						sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
						if (row12.AccountNumber != null) {
							sb_tFileOutputDelimited_9.append(row12.AccountNumber);
						}
						sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
						...
						row17_HashRow.PurchaseOrderNumber = row17.PurchaseOrderNumber;

						row17_HashRow.AccountNumber = row17.AccountNumber;
	...
	public static class DatasetCienciaDeDadosStruct
			implements routines.system.IPersistableRow<DatasetCienciaDeDadosStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_IngestaoCienciaDados = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_IngestaoCienciaDados = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public Object ProductListPrice;

		public Object getProductListPrice() {
			return this.ProductListPrice;
		}

		public java.util.Date ProductSellStartDate;

		public java.util.Date getProductSellStartDate() {
			return this.ProductSellStartDate;
		}

		public java.util.Date ProductSellEndDate;

		public java.util.Date getProductSellEndDate() {
			return this.ProductSellEndDate;
		}

		public java.util.Date ProductDiscontinuedDate;

		public java.util.Date getProductDiscontinuedDate() {
			return this.ProductDiscontinuedDate;
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final DatasetCienciaDeDadosStruct other = (DatasetCienciaDeDadosStruct) obj;
		...
		public void copyDataTo(DatasetCienciaDeDadosStruct other) {

			other.ProductID = this.ProductID;
			other.ProductName = this.ProductName;
			other.ProductColor = this.ProductColor;
			other.ProductStandardCost = this.ProductStandardCost;
			other.ProductListPrice = this.ProductListPrice;
			other.ProductSellStartDate = this.ProductSellStartDate;
			other.ProductSellEndDate = this.ProductSellEndDate;
			other.ProductDiscontinuedDate = this.ProductDiscontinuedDate;
		...
		public void copyKeysDataTo(DatasetCienciaDeDadosStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_IngestaoCienciaDados) {
				...
				try {
					...
					this.ProductListPrice = (Object) dis.readObject();

					this.ProductSellStartDate = readDate(dis);

					this.ProductSellEndDate = readDate(dis);

					this.ProductDiscontinuedDate = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeObject(this.ProductListPrice);

				// java.util.Date

				writeDate(this.ProductSellStartDate, dos);

				// java.util.Date

				writeDate(this.ProductSellEndDate, dos);

				// java.util.Date

				writeDate(this.ProductDiscontinuedDate, dos);
		...
		public String toString() {
			...
			sb.append(",ProductListPrice=" + String.valueOf(ProductListPrice));
			sb.append(",ProductSellStartDate=" + String.valueOf(ProductSellStartDate));
			sb.append(",ProductSellEndDate=" + String.valueOf(ProductSellEndDate));
			sb.append(",ProductDiscontinuedDate=" + String.valueOf(ProductDiscontinuedDate));
		 ...
		 * Compare keys
		 */
		public int compareTo(DatasetCienciaDeDadosStruct other) {
	...
	public void tDBInput_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				SalesProductStruct row21 = SalesProduct;
				DatasetCienciaDeDadosStruct DatasetCienciaDeDados = new DatasetCienciaDeDadosStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "DatasetCienciaDeDados");
				}
				...
				fileName_tFileOutputDelimited_14 = (new java.io.File(
						"D:/Projetos/12ABDGrupo2DataOPS/DL/Curated/ChrunAula03PT02" + TalendDate.getDate("YYYY-MM-DD")
								+ ".csv")).getAbsolutePath().replace("\\", "/");
				...
				if (filetFileOutputDelimited_14.exists()) {
					throw new RuntimeException("The particular file \"" + filetFileOutputDelimited_14.getAbsoluteFile()
				...
				outtFileOutputDelimited_14 = new java.io.BufferedWriter(new java.io.OutputStreamWriter(
						new java.io.FileOutputStream(fileName_tFileOutputDelimited_14, false), "ISO-8859-15"));
...
// ###############################
// # Outputs initialization
				DatasetCienciaDeDadosStruct DatasetCienciaDeDados_tmp = new DatasetCienciaDeDadosStruct();
// ###############################
				...
				fileName_tFileOutputDelimited_12 = (new java.io.File(
						"D:/Projetos/12ABDGrupo2DataOPS/DL/Harmonized/ChrunSalesCurated"
								+ TalendDate.getDate("YYYY-MM-DD") + ".csv")).getAbsolutePath().replace("\\", "/");
...
// ###############################
				...
				final String decryptedPassword_tDBInput_6 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:fVOdj/rb/RN+Df5JdtOWGwnaZJCQMsR2kW4OiFiGO+pRIA7V9g==");
...
// # Output table : 'SalesProduct'
							...
							SalesProduct_tmp.ProductID = row16.ProductID;
...
// Start of branch "SalesProduct"
						if (SalesProduct != null) {
							...
							sb_tFileOutputDelimited_12.append(OUT_DELIM_tFileOutputDelimited_12);
							sb_tFileOutputDelimited_12.append(SalesProduct.ProductID);
							...
							if (!rejectedInnerJoin_tMap_6) { // G_TM_M_020
								...
								Object exprKeyValue_row22__CustomerID = row21.CustomerID;
								if (exprKeyValue_row22__CustomerID == null) {
									hasCasePrimitiveKeyWithNull_tMap_6 = true;
								} else {
									row22HashKey.CustomerID = (int) (Integer) exprKeyValue_row22__CustomerID;
								}
							...
							if (tHash_Lookup_row22 != null && tHash_Lookup_row22.getCount(row22HashKey) > 1) { // G 071
								...
								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
								// 'row22' and it contains more one result from keys : row22.CustomerID = '" +
								// row22HashKey.CustomerID + "'");
							} // G 071
							...
							if (!rejectedInnerJoin_tMap_6) { // G_TM_M_020
								...
								Object exprKeyValue_row23__CustomerID = row21.CustomerID;
								if (exprKeyValue_row23__CustomerID == null) {
									hasCasePrimitiveKeyWithNull_tMap_6 = true;
								} else {
									row23HashKey.CustomerID = (int) (Integer) exprKeyValue_row23__CustomerID;
								}
							...
							if (tHash_Lookup_row23 != null && tHash_Lookup_row23.getCount(row23HashKey) > 1) { // G 071
								...
								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
								// 'row23' and it contains more one result from keys : row23.CustomerID = '" +
								// row23HashKey.CustomerID + "'");
							} // G 071
							...
							if (!rejectedInnerJoin_tMap_6) { // G_TM_M_020
								...
								Object exprKeyValue_row24__ProductID = row21.ProductID;
								if (exprKeyValue_row24__ProductID == null) {
									hasCasePrimitiveKeyWithNull_tMap_6 = true;
								} else {
									row24HashKey.ProductID = (int) (Integer) exprKeyValue_row24__ProductID;
								}
							...
							if (tHash_Lookup_row24 != null && tHash_Lookup_row24.getCount(row24HashKey) > 1) { // G 071
								...
								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
								// 'row24' and it contains more one result from keys : row24.ProductID = '" +
								// row24HashKey.ProductID + "'");
							} // G 071
							...
							{ // start of Var scope
								...
								DatasetCienciaDeDados = null;

// # Output table : 'DatasetCienciaDeDados'
								DatasetCienciaDeDados_tmp.ProductID = row24.ProductID;
								DatasetCienciaDeDados_tmp.ProductName = row24.Name;
								DatasetCienciaDeDados_tmp.ProductColor = row24.Color;
								DatasetCienciaDeDados_tmp.ProductStandardCost = row24.StandardCost;
								DatasetCienciaDeDados_tmp.ProductListPrice = row24.ListPrice;
								DatasetCienciaDeDados_tmp.ProductSellStartDate = row24.SellStartDate;
								DatasetCienciaDeDados_tmp.ProductSellEndDate = row24.SellEndDate;
								DatasetCienciaDeDados_tmp.ProductDiscontinuedDate = row24.DiscontinuedDate;
								DatasetCienciaDeDados_tmp.ProductCategoryName = row24.CategoryName;
								DatasetCienciaDeDados_tmp.ProductModelName = row24.ModelName;
								DatasetCienciaDeDados_tmp.CustomerID = row23.CustomerID;
								DatasetCienciaDeDados_tmp.CompanyName = row23.CompanyName;
								DatasetCienciaDeDados_tmp.SalesPerson = row22.SalesPerson;
								DatasetCienciaDeDados_tmp.SalesOrderID = row21.SalesOrderID;
								DatasetCienciaDeDados_tmp.RevisionNumber = row21.RevisionNumber;
								DatasetCienciaDeDados_tmp.OrderDate = row21.OrderDate;
								DatasetCienciaDeDados_tmp.DueDate = row21.DueDate;
								DatasetCienciaDeDados_tmp.ShipDate = row21.ShipDate;
								DatasetCienciaDeDados_tmp.Status = row21.Status;
								DatasetCienciaDeDados_tmp.OnlineOrderFlag = row21.OnlineOrderFlag;
								DatasetCienciaDeDados_tmp.ShipToAddressID = row21.ShipToAddressID;
								DatasetCienciaDeDados_tmp.BillToAddressID = row21.BillToAddressID;
								DatasetCienciaDeDados_tmp.ShipMethod = row21.ShipMethod;
								DatasetCienciaDeDados_tmp.CreditCardApprovalCode = row21.CreditCardApprovalCode;
								DatasetCienciaDeDados_tmp.TotalDue = row21.TotalDue;
								DatasetCienciaDeDados = DatasetCienciaDeDados_tmp;
// ###############################
							 ...
							 */
// Start of branch "DatasetCienciaDeDados"
							if (DatasetCienciaDeDados != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "DatasetCienciaDeDados");
								}

								StringBuilder sb_tFileOutputDelimited_14 = new StringBuilder();
								sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ProductID);
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductName != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ProductName);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductColor != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ProductColor);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductStandardCost != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ProductStandardCost);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductListPrice != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ProductListPrice);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductSellStartDate != null) {
									sb_tFileOutputDelimited_14.append(FormatterUtils
											.format_Date(DatasetCienciaDeDados.ProductSellStartDate, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductSellEndDate != null) {
									sb_tFileOutputDelimited_14.append(FormatterUtils
											.format_Date(DatasetCienciaDeDados.ProductSellEndDate, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductDiscontinuedDate != null) {
									sb_tFileOutputDelimited_14.append(FormatterUtils
											.format_Date(DatasetCienciaDeDados.ProductDiscontinuedDate, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductCategoryName != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ProductCategoryName);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ProductModelName != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ProductModelName);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.CustomerID);
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.CompanyName != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.CompanyName);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.SalesPerson != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.SalesPerson);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.SalesOrderID);
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.RevisionNumber);
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.OrderDate != null) {
									sb_tFileOutputDelimited_14.append(
											FormatterUtils.format_Date(DatasetCienciaDeDados.OrderDate, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.DueDate != null) {
									sb_tFileOutputDelimited_14.append(
											FormatterUtils.format_Date(DatasetCienciaDeDados.DueDate, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ShipDate != null) {
									sb_tFileOutputDelimited_14.append(
											FormatterUtils.format_Date(DatasetCienciaDeDados.ShipDate, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.Status);
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.OnlineOrderFlag != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.OnlineOrderFlag);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ShipToAddressID != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ShipToAddressID);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.BillToAddressID != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.BillToAddressID);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.ShipMethod != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.ShipMethod);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.CreditCardApprovalCode != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.CreditCardApprovalCode);
								}
								sb_tFileOutputDelimited_14.append(OUT_DELIM_tFileOutputDelimited_14);
								if (DatasetCienciaDeDados.TotalDue != null) {
									sb_tFileOutputDelimited_14.append(DatasetCienciaDeDados.TotalDue
											.setScale(4, java.math.RoundingMode.HALF_UP).toPlainString());
								}
							...
							} // End of branch "DatasetCienciaDeDados"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "DatasetCienciaDeDados");
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_8 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:h1zt66Ax6DBO8WlCwtTJdsRemiNvWOAG81Z4ImcDH6KmtyEwaA==");
...
// ###############################
				...
				final String decryptedPassword_tDBInput_9 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:+iA1h2A6mNx3dxHApGd9ZVhanj4C8ESv24Nz7de1JnBjpExNkw==");
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_10 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ecuBzQMdDEwKtSqmWhQ9pkSzVdb1Cx5Jv3CsmXRUuz+iD9rZwg==");
	...
	public static class Customer1Struct implements routines.system.IPersistableRow<Customer1Struct> {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final Customer1Struct other = (Customer1Struct) obj;
		...
		public void copyDataTo(Customer1Struct other) {
		...
		public void copyKeysDataTo(Customer1Struct other) {
	...
	public void tDBInput_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Customer1Struct row23 = Customer1;
				...
				// source node:tFileOutputDelimited_10 - inputs:(Customer1)
				// outputs:(row23,row23) | target node:tAdvancedHash_row23 - inputs:(row23)
				// outputs:()
				// linked node: tMap_6 - inputs:(row24,row21,row23,row22)
				// outputs:(DatasetCienciaDeDados)
...
// ###############################
				...
				final String decryptedPassword_tDBInput_11 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:W2Uphl7VFahfJkOh3JXFvJQRSIuaTmN4sfNPZ6lmIPeGNkew3w==");
...
// # Output table : 'Customer1'
							Customer1_tmp.CustomerID = row11.CustomerID;
...
// Start of branch "Customer1"
						if (Customer1 != null) {
							...
							sb_tFileOutputDelimited_10.append(Customer1.CustomerID);
							...
							row23_HashRow.CustomerID = row23.CustomerID;

							row23_HashRow.Title = row23.Title;

							row23_HashRow.CompanyName = row23.CompanyName;

							row23_HashRow.EmailAddress = row23.EmailAddress;

							row23_HashRow.Phone = row23.Phone;

							row23_HashRow.AddressLine1 = row23.AddressLine1;

							row23_HashRow.City = row23.City;

							row23_HashRow.StateProvince = row23.StateProvince;

							row23_HashRow.CountryRegion = row23.CountryRegion;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_12 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:1PcO7kj3uleMwWfo9OM/ZUMKtQcFDpZoTOUncgf+yBk0Q2zZJg==");
...
// Start of branch "row18"
	...
	public static class SalesPersonStruct implements routines.system.IPersistableRow<SalesPersonStruct> {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final SalesPersonStruct other = (SalesPersonStruct) obj;
		...
		public void copyDataTo(SalesPersonStruct other) {
		...
		public void copyKeysDataTo(SalesPersonStruct other) {
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tFileOutputDelimited_13 - inputs:(row20) outputs:(row22,row22) |
				...
				fileName_tFileOutputDelimited_13 = (new java.io.File(
						"D:/Projetos/12ABDGrupo2DataOPS/DL/Harmonized/ChrunSalesPerson"
								+ TalendDate.getDate("YYYY-MM-DD") + ".csv")).getAbsolutePath().replace("\\", "/");
...
// # Output table : 'SalesPerson'
								...
								SalesPerson_tmp.CustomerID = row19.CustomerID;
...
// Start of branch "SalesPerson"
							if (SalesPerson != null) {
								...
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									...
									row20.CustomerID = SalesPerson.CustomerID;
...
// Start of branch "row20"
								if (row20 != null) {
									...
									sb_tFileOutputDelimited_13.append(row20.CustomerID);
									...
									row22_HashRow.SalesPerson = row22.SalesPerson;

									row22_HashRow.CustomerID = row22.CustomerID;
...
/************************************************************************************************
 * 725040 characters generated by Talend Open Studio for Data Integration on the
 * July 17, 2021 11:23:41 AM BRT
 ************************************************************************************************/